...
std::cout << "In pos_llhCallback" << std::endl;
		class PIKSI *driver = (class PIKSI*) context;
...
*/
	void baseline_nedCallback(u16 sender_id, u8 len, u8 msg[], void *context)
	{
        ...
        float h_covariance = rtk.h_accuracy * rtk.h_accuracy;
        float v_covariance = rtk.v_accuracy * rtk.v_accuracy;
        
        // set up the pose covariance matrix
